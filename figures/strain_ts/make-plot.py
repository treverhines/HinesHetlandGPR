...
axs[0].fill_between(time,exx-exx_std,exx+exx_std,color='C0',alpha=0.4,zorder=2)
axs[0].grid()
axs[0].set_ylabel('east normal\n[$\mathregular{\mu}$strain/yr]',fontsize=10)

axs[1].plot(time,eyy,'C0-',lw=1.5,zorder=2)
axs[1].fill_between(time,eyy-eyy_std,eyy+eyy_std,color='C0',alpha=0.4,zorder=2)
axs[1].grid()
axs[1].set_ylabel('north normal\n[$\mathregular{\mu}$strain/yr]',fontsize=10)

axs[2].plot(time,exy,'C0-',lw=1.5,zorder=2)
axs[2].fill_between(time,exy-exy_std,exy+exy_std,color='C0',alpha=0.4,zorder=2)
axs[2].grid()
...
_setup_ts_ax(axs)
axs[0].fill_between(time,mag/mag_std,0,edgecolor=c0,facecolor=c0,zorder=2)
axs[0].grid()
...
axs[1].fill_between(time,density,0,edgecolor=c1,facecolor=c1,zorder=2)
axs[1].grid()

...
GNSS data records transient displacements as well as other physical and non-physical processes that we are not interested in. We describe component $i$ of GNSS displacement observations at station location $\vec{x}^{(j)}$ and time $t$ as a realization of the random variable 

...
m = trend(u,t)
u = u - m[0] - m[1]*t
ax.errorbar(t,u,us,marker='None',linestyle='None',color=(1.0,0.7,0.7))
ax.plot(t,u,'r.',ms=4.99)
...
us = 1000*data['east_std_dev'][:,idx]
u = u - m[0] - m[1]*t
ax.errorbar(t,u,us,marker='None',linestyle='None',color=(0.7,0.7,0.7))
ax.plot(t,u,'k.',ms=5.0)

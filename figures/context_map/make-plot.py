...
ax.text(stax-17000.0,stay-23000.0,'SC03',color='r')
idx = np.nonzero(data['id'][...] == 'P436')[0][0]
stax,stay = x[idx],y[idx]
ax.plot(stax,stay,'ro',ms=10,zorder=4)
ax.text(stax-17000.0,stay-23000.0,'P436',color='r')
# plot location of strain time series
stax,stay = bm(-124.03,47.9)
radius = 150000.0
ax.plot(stax,stay,'mo',ms=10,zorder=4)
art = Ellipse((stax,stay),2*radius,2*radius,fc='none',ls='--',ec='m',zorder=4)
ax.add_artist(art)

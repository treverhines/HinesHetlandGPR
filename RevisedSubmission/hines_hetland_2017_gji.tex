...
displacements (i.e., displacements that deviate from the secular
trend), which are constrained by GNSS data.
...
We provide an example to give our prior on $\vec{u}$ a more tangible
meaning. we can use a squared exponential function for $X_i$ and
$T_i$,

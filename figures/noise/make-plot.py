...
axs[0][0].hist(east_p0,np.linspace(0.0,2.0,bins),color='C0')
...
axs[1][0].hist(north_p0,np.linspace(0.0,2.0,bins),color='C0')
...
axs[2][0].hist(vertical_p0,np.linspace(0.0,50.0,bins),color='C0')
...
axs[0][1].hist(east_p1,np.linspace(0.0,8.0,bins),color='C0')
...
axs[1][1].hist(north_p1,np.linspace(0.0,8.0,bins),color='C0')
...
axs[2][1].hist(vertical_p1,np.linspace(0.0,50.0,bins),color='C0')

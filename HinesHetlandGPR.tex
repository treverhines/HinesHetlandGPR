...
e^{-\tfrac{1}{2}\mathbf{d}_*^T\mathbf{K}\mathbf{d}_*},
\end{equation}
where
\begin{equation}
\bm{K} = \bm{\Sigma}^{-1} - 
...
$T$ & direction & $\lambda$  & $\phi$   & $\theta$  & diff. REML \\ \hline
...
IBM & east   & 110 $\pm$ 130 km & 290 $\pm$ 420 mm/yr$^{0.5}$  & -          & -16.4 $\pm$ 7.8 \\
IBM & north  & 150 $\pm$ 560 km & 110 $\pm$ 250 mm/yr$^{0.5}$ & -           & -10.1 $\pm$ 2.3 \\
\end{tabular}

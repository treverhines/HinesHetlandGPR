...
The posterior transient displacements can be evaluated at any $p$. Furthermore, $\hat{u}_i$ is spatially and temporally differentiable, allowing us to formulate $\dot\varepsilon$, which can be evaluated at any $p$. The components of $\dot\varepsilon$ can be written as 

...
axs[0][0].hist(east_p0,np.linspace(0.0,2.0,bins),color='C0',zorder=2)
text = 'median : %.2f\nIQR : %.2f' % (np.median(east_p0),iqr(east_p0))
...
axs[0][0].set_xlabel(r'east $\mathregular{\alpha}$ [mm/yr$^{0.5}$]',fontsize=10)
axs[0][0].tick_params(labelsize=10)


axs[1][0].hist(north_p0,np.linspace(0.0,2.0,bins),color='C0',zorder=2)
text = 'median : %.2f\nIQR : %.2f' % (np.median(north_p0),iqr(north_p0))
...
axs[1][0].set_xlabel(r'north $\mathregular{\alpha}$ [mm/yr$^{0.5}$]',fontsize=10)
axs[1][0].tick_params(labelsize=10)

axs[2][0].hist(vertical_p0,np.linspace(0.0,50.0,bins),color='C0',zorder=2)
text = 'median : %.1f\nIQR : %.1f' % (np.median(vertical_p0),iqr(vertical_p0))
...
axs[2][0].set_xlabel(r'vertical $\mathregular{\alpha}$ [mm/yr$^{0.5}$]',fontsize=10)
axs[2][0].tick_params(labelsize=10)


axs[0][1].hist(east_p1,np.linspace(0.0,8.0,bins),color='C0',zorder=2)
text = 'median : %.2f\nIQR : %.2f' % (np.median(east_p1),iqr(east_p1))
...
axs[0][1].set_xlabel(r'east $\mathregular{\beta}$ [1/yr]',fontsize=10)
axs[0][1].tick_params(labelsize=10)

axs[1][1].hist(north_p1,np.linspace(0.0,8.0,bins),color='C0',zorder=2)
text = 'median : %.2f\nIQR : %.2f' % (np.median(north_p1),iqr(north_p1))
...
axs[1][1].set_xlabel(r'north $\mathregular{\beta}$ [1/yr]',fontsize=10)
axs[1][1].tick_params(labelsize=10)

axs[2][1].hist(vertical_p1,np.linspace(0.0,50.0,bins),color='C0',zorder=2)
text = 'median : %.2f\nIQR : %.2f' % (np.median(vertical_p1),iqr(vertical_p1))
...
axs[2][1].set_xlabel(r'vertical $\mathregular{\beta}$ [1/yr]',fontsize=10)
